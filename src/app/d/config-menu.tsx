...
export const configMenu = [
  {
    ...
    children: [
      ...
      { title: "Master Data Organization Structure", href: "/d/master-data/organization-structure" },
    ...
    children: [
      ...
      { title: "Monitoring MPP - Rekrutmen", href: "/d/mpp/monitoring-mpp-rekruitment" },
    ],
  },
];
